...
trait AcceptHeaderActionProvider {
  ...
  def apply[R[_] <: Request[_]](isOnlyJson: Boolean): AcceptHeaderAction[R]

}

class AcceptHeaderActionProviderImpl @Inject() ()(implicit ec: ExecutionContext) extends AcceptHeaderActionProvider {

  def apply[R[_] <: Request[_]](isOnlyJson: Boolean): AcceptHeaderAction[R] = new AcceptHeaderActionImpl[R](isOnlyJson)
