...
case class ResponseDeparture(departure: String, created: LocalDateTime, updated: LocalDateTime, movementReferenceNumber: String, referenceNumber: String, status: String, messages: String)
