...
class ValidationServiceSpec extends AnyFreeSpec with Matchers with OptionValues with ScalaFutures with MockitoSugar {
  ...
  "validating XML" - {
    ...
    "should return a right with no validation errors" in {
      ...
      val result = sut.validateXml(MessageType.IE015, SchemaValidXml)
    ...
    "non-conforming XML should return a left with a SchemaFailedToValidateError" in {
      val sut    = new ValidationServiceImpl(fakeValidationConnector)
      val result = sut.validateXml(MessageType.IE015, SchemaInvalidXml)
    ...
    "an upstream error should return a left with an UnexpectedError" in {
      val sut    = new ValidationServiceImpl(fakeValidationConnector)
      val result = sut.validateXml(MessageType.IE015, UpstreamError)
    ...
    "an internal exception should return a left with an UnexpectedError" in {
      val sut    = new ValidationServiceImpl(fakeValidationConnector)
      val result = sut.validateXml(MessageType.IE015, InternalServiceError)
  ...
  "validating JSON" - {
    ...
    "should return a right with no validation errors" in {
      val sut    = new ValidationServiceImpl(fakeValidationConnector)
      val result = sut.validateJson(MessageType.IE015, SchemaValidJson)
    ...
    "non-conforming JSON should return a left with a SchemaFailedToValidateError" in {
      val sut    = new ValidationServiceImpl(fakeValidationConnector)
      val result = sut.validateJson(MessageType.IE015, SchemaInvalidJson)
    ...
    "an upstream error should return a left with an UnexpectedError" in {
      val sut    = new ValidationServiceImpl(fakeValidationConnector)
      val result = sut.validateJson(MessageType.IE015, UpstreamError)
    ...
    "an internal exception should return a left with an UnexpectedError" in {
      val sut    = new ValidationServiceImpl(fakeValidationConnector)
      val result = sut.validateJson(MessageType.IE015, InternalServiceError)
