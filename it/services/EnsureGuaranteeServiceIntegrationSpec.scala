...
class EnsureGuaranteeServiceIntegrationSpec extends AnyFreeSpec with Matchers with WiremockSuite with ScalaFutures with IntegrationPatience with ScalaCheckPropertyChecks{
  ...
  "ensureGuarantee" - {
    ...
    val extraGuaranteesInputXML = <CC015B>
      <SynIdeMES1>UNOC</SynIdeMES1>
      <SynVerNumMES2>3</SynVerNumMES2>
      <MesRecMES6>NCTS</MesRecMES6>
      <DatOfPreMES9>20201105</DatOfPreMES9>
    ...
    val extraGuaranteesExpectedXML = <CC015B>
      <SynIdeMES1>UNOC</SynIdeMES1>
      <SynVerNumMES2>3</SynVerNumMES2>
      <MesRecMES6>NCTS</MesRecMES6>
      <DatOfPreMES9>20201105</DatOfPreMES9>
    ...
    val extraGuaranteesComboInputXML = <CC015B>
      <SynIdeMES1>UNOC</SynIdeMES1>
      <SynVerNumMES2>3</SynVerNumMES2>
      <MesRecMES6>NCTS</MesRecMES6>
      <DatOfPreMES9>20201105</DatOfPreMES9>
    ...
    val extraGuaranteesComboExpectedXML = <CC015B>
      <SynIdeMES1>UNOC</SynIdeMES1>
      <SynVerNumMES2>3</SynVerNumMES2>
      <MesRecMES6>NCTS</MesRecMES6>
      <DatOfPreMES9>20201105</DatOfPreMES9>
    ...
    val standardExpectedXML = <CC015B>
      <SynIdeMES1>UNOC</SynIdeMES1>
      <SynVerNumMES2>3</SynVerNumMES2>
      <MesRecMES6>NCTS</MesRecMES6>
      <DatOfPreMES9>20201105</DatOfPreMES9>
    ...
    val oddSpecialMentionsInputXml = <CC015B>
      <SynIdeMES1>UNOC</SynIdeMES1>
      <SynVerNumMES2>3</SynVerNumMES2>
      <MesRecMES6>NCTS</MesRecMES6>
      <DatOfPreMES9>20201105</DatOfPreMES9>
    ...
    val oddSpecialMentionsOutputXml = <CC015B>
      <SynIdeMES1>UNOC</SynIdeMES1>
      <SynVerNumMES2>3</SynVerNumMES2>
      <MesRecMES6>NCTS</MesRecMES6>
      <DatOfPreMES9>20201105</DatOfPreMES9>
    ...
    "result must not be changed if no standard guarantees" in {
      val service = app.injector.instanceOf[EnsureGuaranteeService]
      val result = service.ensureGuarantee(otherInputXML)

      result.right.get.toString().filter(_ > ' ') mustEqual otherInputXML.toString().filter(_ > ' ')
    }

    "must add default special mentions to first good if no special mention present for guarantees" in {
      val service = app.injector.instanceOf[EnsureGuaranteeService]
      val validator = app.injector.instanceOf[XmlValidationService]
      val result = service.ensureGuarantee(extraGuaranteesInputXML)

      result.right.get.toString().filter(_ > ' ') mustEqual extraGuaranteesExpectedXML.toString().filter(_ > ' ')
      validator.validate(result.right.get.toString().filter(_ > ' '), DepartureDeclarationXSD) mustBe a[Right[_, XmlValid]]
    }
    ...
    "must add default special mentions to first good if special mention isn't present for a guarantee" in {
      val service = app.injector.instanceOf[EnsureGuaranteeService]
      val validator = app.injector.instanceOf[XmlValidationService]
      val result = service.ensureGuarantee(extraGuaranteesComboInputXML)

      result.right.get.toString().filter(_ > ' ') mustEqual extraGuaranteesComboExpectedXML.toString().filter(_ > ' ')
      validator.validate(result.right.get.toString().filter(_ > ' '), DepartureDeclarationXSD) mustBe a[Right[_, XmlValid]]
    }
    ...
    "must allow non-guarantee special mentions through without issue" in {
      val service = app.injector.instanceOf[EnsureGuaranteeService]
      val validator = app.injector.instanceOf[XmlValidationService]
      val result = service.ensureGuarantee(oddSpecialMentionsInputXml)

      result.right.get.toString().filter(_ > ' ') mustEqual oddSpecialMentionsOutputXml.toString().filter(_ > ' ')
      validator.validate(result.right.get.toString().filter(_ > ' '), DepartureDeclarationXSD) mustBe a[Right[_, XmlValid]]
